...
with open('datasetViet3.txt', 'r', encoding='utf-8') as file:
    text = file.read()
...
with open('tokenizerv3.pkl', 'wb') as file:
    pickle.dump(tokenizer, file)

modelLSTM = Sequential()
modelLSTM.add(Embedding(total_words, 128, input_length=max_sequence_len-1))
